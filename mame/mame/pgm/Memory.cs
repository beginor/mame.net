...
namespace mame
{
    public partial class PGM
    {
        ...
        public static sbyte MReadByte(int address)
        {
            ...
            {
                result = (sbyte)Video.paletteram16[address - 0xa00000];
            }
        ...
        public static short MReadWord(int address)
        {
            ...
            {
                result = (short)(Video.paletteram16[address - 0xa00000] * 0x100 + Video.paletteram16[address - 0xa00000 + 1]);
            }
        ...
        public static int MReadLong(int address)
        {
            ...
            {
                result = Video.paletteram16[address - 0xa00000] * 0x1000000 + Video.paletteram16[address - 0xa00000 + 1] * 0x10000 + Video.paletteram16[address - 0xa00000 + 2] * 0x100 + Video.paletteram16[address - 0xa00000 + 3];
            }
        ...
        public static void MWriteByte(int address, sbyte value)
        {
            ...
            else if (address >= 0xa00000 && address <= 0xa011ff)
            {
                ...
                Video.paletteram16_xRRRRRGGGGGBBBBB_word_w(offset, (byte)value);
            }
            else if (address >= 0xb00000 && address <= 0xb0ffff)
            {
        ...
        public static void MWriteWord(int address, short value)
        {
            ...
            else if (address >= 0xa00000 && address + 1 <= 0xa011ff)
            {
                ...
                Video.paletteram16_xRRRRRGGGGGBBBBB_word_w(offset, (ushort)value);
            }
            else if (address >= 0xb00000 && address + 1 <= 0xb0ffff)
            {
        ...
        public static void MWriteLong(int address, int value)
        {
            ...
            {
                int offset = (address - 0xa00000) / 2;
                Video.paletteram16_xRRRRRGGGGGBBBBB_word_w(offset, (ushort)(value >> 16));
                Video.paletteram16_xRRRRRGGGGGBBBBB_word_w(offset + 1, (ushort)value);
            }
            else if (address >= 0xb00000 && address + 3 <= 0xb0ffff)
            {
                int offset = (address - 0xb00000) / 2;
        ...
        public static void ZIRQCallback()
        {
