...
namespace cpu.z80
{
    public partial class Z80A
    {
        ...
        public override int ExecuteCycles(int cycles)
        {
            ...
            if (Cpuexec.bLog1==1)
            {
                sw3 = new StreamWriter(@"\VS2008\compare1\compare1\bin\Debug\21.txt", true);
            }
            sbyte Displacement;
            ...
            do
            {
...

                {
                    ...
                    OP = ReadOp(PPC);
                    RegPC.Word++;
                    if (Cpuexec.bLog1 == 2 && pendingCycles == 0x7ba)
                    {
                        int i1 = 1;
                    }
                ...
                if (Cpuexec.bLog1==1)
                {
                    sw3.WriteLine(PPC.ToString("x") + "\t" + OP.ToString("x") + "\t" + pendingCycles.ToString("x"));
                    sw3.WriteLine(RegisterAF.ToString("x") + "\t" + RegisterBC.ToString("x") + "\t" + RegisterDE.ToString("x") + "\t" + RegisterHL.ToString("x") + "\t" + RegisterShadowAF.ToString("x") + "\t" + RegisterShadowBC.ToString("x") + "\t" + RegisterShadowDE.ToString("x") + "\t" + RegisterShadowHL.ToString("x") + "\t" + RegisterI.ToString("x") + "\t" + RegisterR.ToString("x") + "\t" + RegisterIX.ToString("x") + "\t" + RegisterIY.ToString("x") + "\t" + RegisterSP.ToString("x") + "\t" + RegisterPC.ToString("x") + "\t" + Z80A.z1.RegisterWZ.ToString("x") + "\t" + (Z80A.z1.IFF1 ? 1 : 0).ToString("x") + "\t" + (Z80A.z1.IFF2 ? 1 : 0).ToString("x"));
